...
| T-019 | DONE | subsystemCode.Length > 0 guard added to lines 163, 233, 235 of FSharp.Data.XRoad.fs; 4 tests added (empty subsystem errors, valid SUBSYSTEM still parses) |
